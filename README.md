...
* **Real-time News:** Fetches the latest articles using REST API.
* **Modern UI/UX:** Implements `Skeletonizer` for a smooth shimmer loading effect.
* **Error Handling:** Robust `try-catch` blocks and custom exception handling for network issues.
* **Theming:** Supports both **Dark Mode** and **Light Mode**.
* **Responsive Design:** Optimized for various screen sizes.
* **Clean Architecture:** Organized file structure for better maintainability and scalability.
